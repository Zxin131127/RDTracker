...
def run_training_(train_module, train_name, yaml_type, cascade_level, cudnn_benchmark=True):
...
def main():
    ...
    parser.add_argument('--yaml_type', type=str, default='T')
    ...
    run_training_(args.train_module, args.train_name,   args.yaml_type,  args.cascade_level,  args.cudnn_benchmark)
