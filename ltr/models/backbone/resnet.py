...
def resnet50(output_layers=None, pretrained=False, **kwargs):
    ...
    # model = ResNet(Bottleneck, [3, 3, 9, 3], output_layers, **kwargs)

    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet50']))
    return model

from Backbone_MViT.mvit.models.mvit_model import MViT
from Backbone_MViT.mvit.config.defaults import get_cfg
def mvit_transformer_backbone(yaml_path):
    cfg = get_cfg()
