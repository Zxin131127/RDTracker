# from TransformerTrack.pytracking.utils import TrackerParams
# from TransformerTrack.pytracking.features.net_wrappers import NetWithBackbone
...
def parameters():
    ...
    params.net_opt_iter = 30#10
    params.net_opt_update_iter = 10#2
    ...
    params.iounet_k = 2                     # Top-k average to estimate final box
